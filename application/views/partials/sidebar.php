...
<ul class="nav">
    <li>
        <a href="javascript:;" data-target="#sidebar-wrapper" class="sidebar-toggle" title="Toggle sidebar">
...
<ul class="nav" id="menuSm">
    <!-- Seccion de los botones del sidebar del template -->
    <li data-ng-class="{active: isActive('/home')}">
        <a href="<?= base_url('/home') ?>" ng-init="collapseDashboard=true" ng-click="collapseDashboard=!collapseDashboard"><i class="fa fa-tachometer menu-icon"></i> <span >Inicio <i class="text-muted pull-right fa fa-plus-square-o"></i></span></a>
        <ul class="nav nav-sub pull-down collapse" ng-class="{in: !collapseDashboard}" id="dashboardMenu">
            <li data-ng-class="{active: isActive('/dashboard-1')}"><a href="/dashboard-1">Dashboard 1</a></li>
