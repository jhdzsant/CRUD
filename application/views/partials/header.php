    ...
    <div class="container-fluid">
     ...
     <nav class="collapse navbar-collapse">
            ...
            <ul class="nav navbar-nav navbar-right">
                <!--    <li class="hidden-xs"><a class="dropdown-toggle" href="javascript:;" data-toggle="dropdown" title="Notifications"><span class="fa fa-bell fa-lg"><span class="count-circle count-circle-middle slide-up">1</span></span></a>
